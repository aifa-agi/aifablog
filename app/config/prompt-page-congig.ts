// @/app/config/prompt-page-config.ts

/**
 * Base prompt configuration for AI content generation
 * This file exports the system instruction template
 */
export const promptPageConfig = `
