...
// @/app/(_routing)/admin/pages/[slug]/(_service)/(_components)/admin-pages/admin-page-sections/constants/instructions.ts
export const managementInstructions = `In this section you manage your page design. You can move sections, group them, restart content generation for individual sections or groups. You can replace standard Typography design with section design. 
