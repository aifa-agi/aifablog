...
export const DialogsContext = createContext<DialogsContextValue | undefined>(undefined);
...
export function DialogsProvider({ children }: { children: ReactNode }) {
  ...
  React.useEffect(() => {
    if (dialogState.dialog.open) {
      ...
      images.setImagesList(dialogState.dialog.images ?? [{ id: generateCuid(), alt: "", href: "" }]);
    } else {
      keywords.reset();
      images.reset();
    }
