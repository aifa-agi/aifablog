 ...
 */
export function areAllLinksActive(linkConfiguration: LinkConfiguration): boolean {
  return (
 ...
 */
export function toggleLinkItemState(currentState: LinkItemState): LinkItemState {
